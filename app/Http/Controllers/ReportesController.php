...
class ReportesController extends Controller
{
    ...
    public function donacionesPorPeriodo(Request $request)
    {
        ...
        return view('reportes.donaciones_periodo', compact(
            'donaciones',
            'totalDonaciones',
            'totalMonto',
            'donacionesPorTipo',
    ...
    public function inventarioPorAlmacen(Request $request)
    {
        ...
        $ubicaciones = \App\Models\UbicacionesDonacione::with([
        ...
        return view('reportes.inventario_almacen', compact(
            'almacenes',
            'productosAgrupados',
            'totalProductos',
            'cantidadTotal',
    ...
    public function solicitudesRecoleccion(Request $request)
    {
        ...
        return view('reportes.solicitudes_recoleccion', compact(
            'solicitudes',
            'totalSolicitudes',
            'solicitudesPorEstado',
            'request'
    ...
    public function salidasProductos(Request $request)
    {
        ...
        return view('reportes.salidas_productos', compact(
            'salidasDetalladas',
            'totalSalidas',
            'cantidadTotal',
            'request'
