...
<div class="card card-primary collapsed-card">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('reportes.distribucion') }}">
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('reportes.distribucion') }}" class="btn btn-secondary">
                ...
                <tbody>
                    @forelse($salidasDetalladas as $salida)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('registros-salida.show', $salida['id_salida']) }}"
