    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('reportes.donaciones.periodo') }}" method="GET">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-success card-outline">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('reportes.inventario.almacen') }}" method="GET">
                    <div class="form-group">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-info card-outline">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('reportes.salidas') }}" method="GET">
                    <div class="form-group">
                        <label>Fecha Inicio (opcional)</label>
                        <input type="date" name="fecha_inicio" class="form-control">
                    </div>
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-danger card-outline">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('reportes.campanas') }}" method="GET">
                    <div class="form-group">
                        <label>Estado</label>
                        <select name="estado" class="form-control">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card card-dark card-outline">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('reportes.distribucion') }}" method="GET">
                    <div class="form-group">
                        <label>Fecha Inicio (opcional)</label>
                        <input type="date" name="fecha_inicio" class="form-control">
                    </div>
