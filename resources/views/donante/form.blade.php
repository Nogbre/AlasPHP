<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="id_donante" class="form-control" value="{{ old('id_donante', $donante->id_donante) }}" id="id_donante" readonly>
        </div>
        @endif
        <div class="form-group mb-2 mb20">
            <label for="nombre" class="form-label">{{ __('Nombre') }} <span class="text-danger">*</span></label>
            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre', $donante?->nombre) }}" id="nombre" placeholder="Nombre" required maxlength="150">
            @error('nombre')
                <span class="invalid-feedback d-block error-message" role="alert" data-field="nombre">
                    <strong>{{ $message }}</strong>
                </span>
            @enderror
            <span class="invalid-feedback d-block error-message" role="alert" data-field="nombre" style="display: none;">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $donante?->email) }}" id="email" placeholder="Email" maxlength="100">
            @error('email')
                <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <textarea name="direccion" class="form-control @error('direccion') is-invalid @enderror" id="direccion" placeholder="Direccion" rows="3">{{ old('direccion', $donante?->direccion) }}</textarea>
            @error('direccion')
                <span class="invalid-feedback d-block" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="fecha_registro" class="form-control" value="{{ old('fecha_registro', $donante->fecha_registro) }}" id="fecha_registro" readonly>
        </div>
        @endif
