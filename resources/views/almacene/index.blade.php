                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <a class="btn btn-info btn-sm" href="{{ route('almacene.show', $almacene->id_almacen) }}" title="Ver detalles">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a class="btn btn-warning btn-sm" href="{{ route('almacene.edit', $almacene->id_almacen) }}" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('almacene.destroy', $almacene->id_almacen) }}" method="POST" style="display: inline;" onsubmit="return confirm('¿Está seguro de eliminar este almacén?');">
                                        @csrf
                                        @method('DELETE')
